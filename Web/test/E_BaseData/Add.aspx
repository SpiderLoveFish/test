<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="Spider.Web.test.E_BaseData.Add" Title="增加页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtFactoryID" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		流水线编号
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtPipelineID" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		流水线父项编号
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtPipeParentID" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		站点ID（与单片机好连接）
